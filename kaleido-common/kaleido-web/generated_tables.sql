...
CREATE TABLE IF NOT EXISTS `t_wardrobe_brand` (
    ...
    `created_at` datetime COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `updated_at` datetime COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    `deleted` tinyint COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '是否删除：0-未删除，1-已删除',
    `lock_version` int COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '乐观锁版本号',
...
CREATE TABLE IF NOT EXISTS `t_wardrobe_clothing` (
    ...
    `purchase_date` datetime COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '购买日期',
    `price` decimal(10,2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '价格',
...
CREATE TABLE IF NOT EXISTS `t_wardrobe_clothing_image` (
    ...
    `image_order` int COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '图片排序',
    `is_primary` tinyint COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '是否为主图',
    `image_size` bigint COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片大小（字节）',
    `image_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片类型',
    `width` int COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片宽度（像素）',
    `height` int COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片高度（像素）'
    PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `t_wardrobe_location_image` (
    ...
    `path` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片路径（在minio中的文件路径）',
    `image_order` int COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '排序序号',
    `is_primary` tinyint COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '是否为主图',
    `image_size` bigint COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片大小（字节）',
    `image_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '文件类型',
    `width` int COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片宽度',
    `height` int COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片高度'
    PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `t_wardrobe_location_record` (
    ...
    `record_time` datetime COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '记录时间',
    `notes` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注',
    `is_current` int COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '是否为当前位置记录'
    PRIMARY KEY (`id`)
    ,KEY `idx_clothing_id` (`clothing_id`)
    ,KEY `idx_location_id` (`location_id`)
    ,KEY `idx_user_id` (`user_id`)
...
CREATE TABLE IF NOT EXISTS `t_wardrobe_outfit` (
    ...
    `is_public` tinyint COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '是否公开',
    `favorite_count` int COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '收藏数',
    `view_count` int COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '浏览数',
    `rating` double COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '评分',
    `rating_count` int COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '评分人数'
    PRIMARY KEY (`id`)
    ,UNIQUE KEY `uk_name` (`name`)
    ,KEY `idx_user_id` (`user_id`)
...
CREATE TABLE IF NOT EXISTS `t_tag` (
    ...
    `usage_count` int COLLATE utf8mb4_unicode_ci DEFAULT '0' COMMENT '使用次数'
    PRIMARY KEY (`id`)
    ,UNIQUE KEY `uk_name` (`name`)
    ,KEY `idx_user_id` (`user_id`)
