 ...
 */
@Component
public class ClothingImageConversionStrategy implements ImageConversionStrategy<ClothingImageInfoDTO> {
    
    @Override
    public ClothingImageInfoDTO convert(BasicImageInfo basicInfo, ImageInfo minioInfo) {
        if (minioInfo != null) {
