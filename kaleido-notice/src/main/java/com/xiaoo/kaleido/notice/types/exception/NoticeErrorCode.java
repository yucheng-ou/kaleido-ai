...
public enum NoticeErrorCode implements ErrorCode {
    ...
    VERIFICATION_CODE_TEMPLATE_EMPTY("VERIFICATION_CODE_TEMPLATE_EMPTY", "验证码通知模板为空"),
    ...
    // 适配器相关错误
    UNSUPPORTED_NOTICE_TYPE("UNSUPPORTED_NOTICE_TYPE", "不支持的通知类型"),
    NOTICE_ADAPTER_NOT_FOUND("NOTICE_ADAPTER_NOT_FOUND", "通知适配器未找到");
