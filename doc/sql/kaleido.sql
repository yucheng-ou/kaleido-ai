...
-- 正在导出表  kaleido_0.t_ai_agent 的数据：~23 rows (大约)
...
-- 正在导出表  kaleido_0.t_ai_agent_tool 的数据：~12 rows (大约)
...
-- 正在导出表  kaleido_0.t_ai_conversation 的数据：~6 rows (大约)
...
-- 正在导出表  kaleido_0.t_ai_workflow 的数据：~3 rows (大约)
...
-- 正在导出表  kaleido_0.t_ai_workflow_execution 的数据：~21 rows (大约)
...
-- 导出  表 kaleido_0.t_mq_message 结构
CREATE TABLE IF NOT EXISTS `t_mq_message` (
  ...
  `lock_version` int NOT NULL DEFAULT '0' COMMENT '乐观锁版本号',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户id',
  `message` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '消息主体',
  `topic` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '消息主题',
  `state` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '任务状态；create-创建、completed-完成、fail-失败',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='mq消息表';

-- 正在导出表  kaleido_0.t_mq_message 的数据：~0 rows (大约)
DELETE FROM `t_mq_message`;
/*!40000 ALTER TABLE `t_mq_message` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_mq_message` ENABLE KEYS */;
...
-- 正在导出表  kaleido_0.t_recommend_record_0 的数据：~12 rows (大约)
...
-- 正在导出表  kaleido_0.t_user_coin_stream 的数据：~49 rows (大约)
...
-- 正在导出表  kaleido_0.t_wardrobe_outfit 的数据：~16 rows (大约)
...
-- 正在导出表  kaleido_0.t_wardrobe_outfit_clothing 的数据：~39 rows (大约)
...
-- 正在导出表  kaleido_0.t_wardrobe_outfit_image 的数据：~16 rows (大约)
